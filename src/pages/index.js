    ...
    <main className={container}>
      ...
      <Skills>
        ...
        <SocialFollow>
          ...
          <div class="container max-w-screen-lg mx-auto mt-3">
            <div>
              <div class="flex flex-wrap justify-center gap-2">
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <button class="bg-blue-400 p-2 font-semibold text-white inline-flex items-center space-x-2 mr-3 rounded">
                    <svg
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <button class="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 mr-3 rounded">
                    <svg
                      class="w-5 h-5 fill-current"
                      role="img"
                      viewBox="0 0 256 256"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <button class="bg-red-600 p-2 font-semibold text-white inline-flex items-center space-x-2 mr-3 rounded">
                    <svg
                      class="w-5 h-5 fill-current"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 16 16"
